                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="airplane_id" id="airplane_id">
                                    ...
                                    <option value="{{ $airplane->id }}" {{ $flight->id == $airplane->id ? 'selected' : '' }}>{{ $airplane->aircraft_type }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="from_airport_id" id="from_airport_id">
                                    ...
                                    <option value="{{ $airport->id }}" {{ $flight->from_airport_id == $airport->id ? 'selected' : '' }}>{{ $airport->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="destination_airport_id" id="destination_airport_id">
                                    @foreach ($airports as $airport)
                                    <option value="{{ $airport->id }}" {{ $flight->destination_airport_id == $airport->id ? 'selected' : '' }}>{{ $airport->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
