...
<div class="my-container" style="margin-top: 20px">
    <div class="row">
		...
		<div class="col-md-8">
            <a href="{{ URL::previous() }}" class="bold" style="display: inline-block; margin-bottom: 15px">&#10094;&nbsp; Kembali ke Data Pemesanan</a>
                ...
                <div class="panel-body">
                    <div class="row" style="margin-bottom: 15px">
                        ...
                        <div class="col-md-4">
                            ...
                            <span class="text-black bold">{{ date('d F Y', strtotime($booking->bookingDetail->customer_name)) }}</span>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <small class="bold text-grey">Jenis Pembayaran</small><br>
                            <span class="text-black bold">Transfer</span>
                        </div>
                        <div class="col-md-8">
