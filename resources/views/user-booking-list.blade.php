				...
				<div class="panel-body">
					...
					<div class="row" style="margin-top: 10px">
						...
						<div class="col-md-6 text-right">
							...
							<a href="javascript:" data-toggle="popover" data-content="<a href='{{ route('booking.delete', ['id' => $booking->id]) }}' class='popover-text bold text-black'>Hapus Pesanan</a>" style="margin-left: 15px">
								<img src="/img/icons/more.png" class="my-icon" alt="">
							</a>
							@endif
						</div>
